...
local col_accent        = Color(255, 180, 0,   255)  -- amber for B-52

local SECTION_COLORS = {
    ["NPC Call Settings"] = Color(60,  120, 200, 120),
    ["B-52 Behaviour"]    = Color(180, 120, 40,  120),
    ...
    spawnmenu.AddToolMenuOption(
        ...
        function(panel)
            ...
            header.Paint = function(self, w, h)
                ...
                draw.SimpleText("B-52 Stratofortress Controller", "DermaLarge",
            ...
            panel:NumSlider("Lifetime (seconds)",         "npc_bombinb52_lifetime", 10,   600,  0)
            panel:NumSlider("Forward speed (HU/s)",       "npc_bombinb52_speed",    50,   800,  0)
            panel:NumSlider("Orbit radius (HU)",          "npc_bombinb52_radius",   500,  20000, 0)
            panel:NumSlider("Altitude above ground (HU)", "npc_bombinb52_height",   1000, 30000, 0)
