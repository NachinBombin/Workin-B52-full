...
--  lua/autorun/client/cl_bombin_support_b52_menu.lua
-- ============================================================
...
local col_accent        = Color(255, 140,   0, 255)  -- amber for B-52
...
local SECTION_COLORS = {
    ...
    ["B-52 Behaviour"]    = Color(180, 100,  40, 120),
...
hook.Add("PopulateToolMenu", "BombinSupportB52_ToolMenu", function()
    spawnmenu.AddToolMenuOption(
        ...
        function(panel)
            ...
            panel:NumSlider("Flare to arrival delay (s)", "npc_bombinb52_delay",   1,   30,   0)
